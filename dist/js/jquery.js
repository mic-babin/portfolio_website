$(document).ready(function() {
  ...
  $("#image").html(
    " <img class='gallery_img_style' src='img/nature/" + name + "' > "
  );

  // loop = setInterval(slider, 999999);

  function slider() {
    last_index = $(".thumbs_style")
      .last()
      .index();
    ...
    $("#large_img").fadeOut(300, function() {
      $(this).attr("src", "img/nature/" + name);
      $(this).fadeIn(300);
    });

    $(".thumbs_style img").css("border", "2px solid rgba(0,0,0,0.4)");
    $(".thumbs_style")
      .eq(index)
      .find("img")
      .css("border", "2px solid #ffbc00");
  ...
  $(".thumbs_style img").click(function() {
    ...
    $(".thumbs_style img").css("border", "2px solid rgba(0,0,0,0.4)");
    $(this).css("border", "2px solid #ffbc00");
  ...
  $("body").append(
    "<div id='enlarge'><div> <img id='large_img' src='" +
      name +
      "'> <img id='large_close' src='img/slider/icons/close.png'> <img id='large_left' src='img/slider/icons/left.png'> <img id='large_right' src='img/slider/icons/right.png'> <img id='large_pause' src='img/slider/icons/pause.png'> <img id='large_play' src='img/slider/icons/play.png'>  </div></div> "
  );
